...
const {cityVehicleData, updateSelectedVehicle, updateSelectedCity} = useCapture()
  ...
  <div @click="onOutsideClick()"
    ...
    <div @click.stop="setIsOpen(true)"
      ...
      <div v-if="type==='city'" v-for="city in cities">
        <div @click.stop="selectedId = city.id" class="w-full h-full relative">
      ...
      <div v-else v-for="vehicle in vehicles">
        <div @click.stop="selectedId = vehicle.id" class="h-full w-full relative">
